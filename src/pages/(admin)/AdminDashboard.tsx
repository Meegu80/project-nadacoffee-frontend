  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-black text-[#222222] tracking-tight">DASHBOARD</h2>
          <p className="text-sm text-gray-500 mt-1 font-medium">오늘의 나다커피 운영 현황입니다.</p>
        </div>
        <div className="text-sm font-bold text-gray-400 bg-white px-4 py-2 rounded-lg border border-gray-100 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-gray-50 flex items-center justify-between">
              ...
              <Link to="/admin/orders" className="text-xs font-bold text-gray-400 hover:text-[#222222] flex items-center gap-1">
                전체보기 <MdOutlineChevronRight size={16} />
              </Link>
            </div>
        ...
        {/* 5. Sidebar: Inventory & Quick Actions */}
        <div className="space-y-8">
          {/* Inventory Alerts */}
          <div className="bg-[#222222] text-white p-8 rounded-3xl shadow-xl shadow-black/10">
          ...
          {/* Quick Actions */}
          <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
            <h3 className="text-lg font-black text-[#222222] mb-6">빠른 작업</h3>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <Link 
                  key={action.label}
                  to={action.path}
                  className="flex flex-col items-center justify-center p-4 rounded-2xl bg-gray-50 hover:bg-[#FFD400] group transition-all"
                >
                  <action.icon size={24} className="text-gray-400 group-hover:text-black mb-2" />
                  <span className="text-[10px] font-black text-gray-500 group-hover:text-black">{action.label}</span>
                </Link>
              ))}
            </div>
          </div>
