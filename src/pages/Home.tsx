...
function Home() {
   return (
      <div className="relative">
         ...
         <section
            className={twMerge([
               "relative h-screen w-full flex items-center justify-center overflow-hidden bg-black",
            ])}>
            <div className="absolute inset-0 z-0">
               ...
               <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
                  <iframe
                     className={twMerge([
                        "absolute top-1/2 left-1/2 w-[300%] h-[300%] -translate-x-1/2 -translate-y-1/2 opacity-70",
                     ])}
            ...
            <div className="relative z-20 text-center px-4 w-full max-w-4xl">
               <motion.div
                  ...
                  <p className="text-gray-300 text-lg md:text-xl mb-16 font-medium max-w-3xl mx-auto">
                     나다커피는 영화 해바라기의 명대사 "나다 이 OO야"에서 영감을
                     받아 창립한 브랜드입니다.
                     <br />
